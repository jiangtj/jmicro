...
public class AuthHolder {
    ...
    public AuthContext getAuthContext() {
        ...
        AuthContext context = (AuthContext) requestAttributes.getAttribute(AuthRequestAttributes.AUTH_CONTEXT_ATTRIBUTE,
            RequestAttributes.SCOPE_REQUEST);
        if (context == null) {
            context = factory.getAuthContext(new ServletAuthRequest(requestAttributes.getRequest()));
            requestAttributes.setAttribute(AuthRequestAttributes.AUTH_CONTEXT_ATTRIBUTE, context,
                RequestAttributes.SCOPE_REQUEST);
        }
        return context;
    }
    ...
    public void setAuthContext(AuthContext ctx) {
        ServletRequestAttributes requestAttributes = currentRequestAttributes();
        requestAttributes.setAttribute(AuthRequestAttributes.AUTH_CONTEXT_ATTRIBUTE, ctx,
            RequestAttributes.SCOPE_REQUEST);
    }
