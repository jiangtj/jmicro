...
import com.jiangtj.micro.sql.jooq.jooq.tables.pojos.SystemOperateRecord;
...
public class SystemOperateRecordRecord extends UpdatableRecordImpl<SystemOperateRecordRecord> implements Record4<Long, LocalDateTime, Long, String> {
    ...
    public Field<Long> field1() {
        return com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD.ID;
    }

    @Override
    public Field<LocalDateTime> field2() {
        return com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD.CREATE_TIME;
    }

    @Override
    public Field<Long> field3() {
        return com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD.OPERATOR;
    }

    @Override
    public Field<String> field4() {
        return com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD.CONTENT;
    }
    ...
    public SystemOperateRecordRecord() {
        super(com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD);
    }
     ...
     * Create a detached, initialised SystemOperateRecordRecord
     */
    public SystemOperateRecordRecord(SystemOperateRecord value) {
        super(com.jiangtj.micro.sql.jooq.jooq.tables.SystemOperateRecord.SYSTEM_OPERATE_RECORD);
